...
public class kafkaconsumerwithgroups {
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(kafkaconsumerwithgroups.class.getName());
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG,"my-fifth-application");
